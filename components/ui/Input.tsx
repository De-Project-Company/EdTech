...
const inputVariants = cva(
  'relative px-4 py-3 flex items-center justify-center gap-3 w-fit h-[48px] rounded-[10px] text-black hide-caret transition-all select-none focus-within:border-primary-light ',
  {
    variants: {
      intent: {
